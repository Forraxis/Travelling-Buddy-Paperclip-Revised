      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 p-4">
        <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
          ...
          <p className="mb-4 text-sm text-gray-600">
            Create a free account to submit accessories and help build the
            catalogue for the Australian touring community.
            {form.modelName && (
              <span className="mt-1 block text-gray-500">
                Your entry for <strong>{form.modelName}</strong> will be saved
          ...
          <button
            ...
            className="bg-tb-primary hover:bg-tb-primary-dark block w-full rounded-lg px-4 py-2.5 text-center text-sm font-medium text-white"
          >
            Create account
          </button>
          <button
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, mountingLocation: e.target.value }))
                  }
                  className="focus:border-tb-primary w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="text-tb-primary h-4 w-4 rounded border-gray-300"
                />
              ...
              <button
                ...
                className="bg-tb-primary hover:bg-tb-primary-dark w-full rounded-lg px-4 py-2.5 text-sm font-medium text-white disabled:cursor-not-allowed disabled:opacity-50"
              >
                Next: Add photo
              </button>
            </div>
          ...
          {step === 'photo' && (
            <div className="space-y-3">
              <p className="text-sm text-gray-600">
                A photo helps moderators verify your submission and makes it
              ...
              {photoPreview ? (
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 rounded-full bg-white/80 p-1 text-gray-600 hover:bg-white"
                  >
                    <svg
                      className="h-4 w-4"
                      viewBox="0 0 20 20"
                ...
                <button
                  ...
                  disabled={uploading}
                  className="hover:border-tb-primary hover:text-tb-primary flex h-32 w-full flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-gray-200 text-gray-400"
                >
                  <svg
                    className="h-8 w-8"
                    viewBox="0 0 24 24"
            ...
            <div className="space-y-3">
              <div className="rounded-lg bg-gray-50 p-3 text-sm">
                ...
                <p className="text-gray-500">
                  {form.weightKg} kg · {form.categoryName || 'accessory'}
                </p>
                {photoPreview && (
                  // eslint-disable-next-line @next/next/no-img-element
                  <img
          ...
          {step === 'duplicate' && (
            <div className="space-y-3">
              <p className="text-sm text-gray-700">
                We may already have{' '}
                <strong>
                  {duplicateInfo?.existingName || 'this accessory'}
                </strong>{' '}
                in the catalogue.
              </p>
              <p className="text-sm text-gray-500">
                Is yours different from the existing entry?
              </p>
            ...
            <div className="space-y-3 text-center">
              ...
              <div>
                <p className="font-medium text-gray-900">
                  Accessory added to your calculation
                </p>
