...
function CategoryCard({ category }: { category: AccessoryCategoryTree }) {
  return (
    <Link
      ...
      className="group border-tb-neutral-200 flex flex-col gap-1 rounded-xl border bg-white p-5 transition-shadow hover:shadow-md"
    >
...
export default async function AccessoriesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-tb-primary text-2xl font-bold">Accessories</h1>
