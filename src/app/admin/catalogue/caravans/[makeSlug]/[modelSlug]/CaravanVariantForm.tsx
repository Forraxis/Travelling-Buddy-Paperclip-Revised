...
export function CaravanVariantForm({
  modelId,
  variant,
  backHref,
}: CaravanVariantFormProps) {
  ...
  function validate(): boolean {
    ...
    if (isMultiAxle(axleConfiguration)) {
      if (!axleSpacingMm) {
        ...
        isNaN(parseInt(axleSpacingMm)) ||
        parseInt(axleSpacingMm) < 0
      ) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const input = {
      ...
      axleSpacingMm:
        isMultiAxle(axleConfiguration) && axleSpacingMm
          ? parseInt(axleSpacingMm)
          : null,
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <FormField label="ATM (kg)" name="atmKg" error={errors.atmKg}>
            <input
              ...
              type="number"
              value={atmKg}
              onChange={(e) => setAtmKg(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField label="GTM (kg)" name="gtmKg" error={errors.gtmKg}>
            <input
              ...
              type="number"
              value={gtmKg}
              onChange={(e) => setGtmKg(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          ...
          <FormField label="TBM (kg)" name="tbmKg" error={errors.tbmKg}>
            <input
              ...
              type="number"
              value={tbmKg}
              onChange={(e) => setTbmKg(e.target.value)}
              className={inputClassName}
            />
          </FormField>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <FormField label="Axle Configuration" name="axleConfiguration">
            <select
              ...
              onChange={(e) =>
                setAxleConfiguration(e.target.value as AxleConfiguration)
              }
              className={selectClassName}
            >
              {AXLE_CONFIGS.map((ac) => (
          ...
          <FormField
            label="Coupling to Axle (mm)"
            name="couplingToAxleMm"
            error={errors.couplingToAxleMm}
          >
            <input
              id="couplingToAxleMm"
              type="number"
              value={couplingToAxleMm}
              onChange={(e) => setCouplingToAxleMm(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField
      ...
      <div className="border-tb-neutral-200 rounded-lg border bg-white p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <FormField
            ...
            name="bodyLengthMm"
            error={errors.bodyLengthMm}
          >
            <input
              id="bodyLengthMm"
              type="number"
              value={bodyLengthMm}
              onChange={(e) => setBodyLengthMm(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField
            ...
            error={errors.overallLengthMm}
          >
            <input
              id="overallLengthMm"
              type="number"
              value={overallLengthMm}
              onChange={(e) => setOverallLengthMm(e.target.value)}
              className={inputClassName}
            />
          </FormField>
        </div>
      ...
      <div className="border-tb-neutral-200 rounded-lg border bg-white p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <FormField
            label="Fresh Water (L)"
            name="freshWaterCapacityL"
            error={errors.freshWaterCapacityL}
          >
            <input
              id="freshWaterCapacityL"
              type="number"
          ...
          <FormField
            label="Grey Water (L)"
            name="greyWaterCapacityL"
            error={errors.greyWaterCapacityL}
          >
            <input
              id="greyWaterCapacityL"
              type="number"
