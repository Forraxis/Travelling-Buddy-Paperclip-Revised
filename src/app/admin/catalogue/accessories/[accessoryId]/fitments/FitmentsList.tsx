...
export function FitmentsList({
  ...
  const [deleteTarget, setDeleteTarget] = useState<AccessoryFitmentDto | null>(null);
        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-tb-neutral-200 bg-tb-neutral-50">
              ...
              <th className="px-4 py-3 font-medium text-gray-700">Mounting Location</th>
              <th className="px-4 py-3 font-medium text-gray-700">Weight (kg)</th>
              <th className="px-4 py-3 font-medium text-gray-700">Confidence</th>
            ...
            {fitments.length === 0 ? (
              <tr>
                <td colSpan={5} className="px-4 py-8 text-center text-gray-500">
                  No fitments yet. Click &apos;+ Add Fitment&apos; to get started.
                </td>
              </tr>
            ) : (
              fitments.map((f) => (
