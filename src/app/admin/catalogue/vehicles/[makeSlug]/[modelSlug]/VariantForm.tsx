...
export function VariantForm({ modelId, variant, backHref }: VariantFormProps) {
  ...
  function validate(): boolean {
    ...
    if (!isCurrentProduction && !yearTo)
      errs.yearTo = 'Year to is required (or mark as current production)';
      ...
      <div className="border-tb-neutral-200 rounded-lg border bg-white p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <FormField
            ...
            name="kerbWeightKg"
            error={errors.kerbWeightKg}
          >
            <input
              id="kerbWeightKg"
              type="number"
              value={kerbWeightKg}
              onChange={(e) => setKerbWeightKg(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField
            label="Max Towing Capacity (kg)"
            name="maxTowingCapacityKg"
            error={errors.maxTowingCapacityKg}
          >
            <input
              id="maxTowingCapacityKg"
              type="number"
              value={maxTowingCapacityKg}
              onChange={(e) => setMaxTowingCapacityKg(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField
            label="Front Axle Limit (kg)"
            name="frontAxleLimitKg"
            error={errors.frontAxleLimitKg}
          >
            <input
              id="frontAxleLimitKg"
              type="number"
          ...
          <FormField
            label="Rear Axle Limit (kg)"
            name="rearAxleLimitKg"
            error={errors.rearAxleLimitKg}
          >
            <input
              id="rearAxleLimitKg"
              type="number"
          ...
          <FormField
            label="Max Tow Ball Download (kg)"
            name="maxTowBallDownloadKg"
            error={errors.maxTowBallDownloadKg}
          >
            <input
              id="maxTowBallDownloadKg"
              type="number"
              value={maxTowBallDownloadKg}
              onChange={(e) => setMaxTowBallDownloadKg(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField
            ...
            error={errors.fuelTankCapacityL}
          >
            <input
              id="fuelTankCapacityL"
              type="number"
              value={fuelTankCapacityL}
              onChange={(e) => setFuelTankCapacityL(e.target.value)}
              className={inputClassName}
            />
          </FormField>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <FormField label="Front Overhang (mm)" name="frontOverhangMm">
            <input
              id="frontOverhangMm"
              type="number"
              value={frontOverhangMm}
              onChange={(e) => setFrontOverhangMm(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField label="Rear Overhang (mm)" name="rearOverhangMm">
            <input
              id="rearOverhangMm"
              type="number"
              value={rearOverhangMm}
              onChange={(e) => setRearOverhangMm(e.target.value)}
              className={inputClassName}
            />
          </FormField>
          <FormField label="Total Length (mm)" name="totalLengthMm">
            <input
              ...
              type="number"
              value={totalLengthMm}
              onChange={(e) => setTotalLengthMm(e.target.value)}
              className={inputClassName}
            />
          </FormField>
        </div>
