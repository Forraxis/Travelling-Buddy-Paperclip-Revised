...
import type { AccessoryBrandDto, PaginatedResult } from "@/modules/catalogue/types/accessory-brand.types";
...
export function BrandsList({
  ...
  const [deleteTarget, setDeleteTarget] = useState<AccessoryBrandDto | null>(null);
  ...
  function handleLoadMore() {
    ...
    startTransition(async () => {
      const more = await listBrandsAction(data.nextCursor!, search || undefined);
      setData({
