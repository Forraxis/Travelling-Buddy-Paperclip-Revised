...
import { getVlmVerdict, getVlmSummary, getEntityName } from "./_components/types";
...
export default async function ModerationQueuePage() {
  ...
  const unified: UnifiedSubmission[] = [
    ...vehicles.map((v) => ({
      ...
      submitter: { id: v.submitter.id, name: v.submitter.name, trustTier: v.submitter.trustTier },
    ...
    ...caravans.map((c) => ({
      ...
      submitter: { id: c.submitter.id, name: c.submitter.name, trustTier: c.submitter.trustTier },
    ...
    ...accessories.map((a) => ({
      ...
      submitter: { id: a.submitter.id, name: a.submitter.name, trustTier: a.submitter.trustTier },
