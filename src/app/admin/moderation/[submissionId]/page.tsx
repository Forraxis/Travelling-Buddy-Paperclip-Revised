...
export default async function SubmissionDetailPage({
  ...
  if (subType === 'vehicle') {
    ...
    return (
      <SubmissionDetailView
        ...
        photoUrls={
          [sub.compliancePlatePhotoUrl, ...sub.additionalPhotoUrls].filter(
            Boolean,
          ) as string[]
        }
        vlmGatekeeperResult={
          sub.vlmGatekeeperResult as Record<string, unknown> | null
        }
        vlmExtractionResult={
          sub.vlmExtractionResult as Record<string, unknown> | null
        }
        ...
        decidedBy={
          sub.decidedBy
            ? { id: sub.decidedBy.id, name: sub.decidedBy.name }
            : null
        }
  ...
  return (
    <SubmissionDetailView
      ...
      submittedData={sub.submittedData as Record<string, unknown>}
      photoUrls={
        [sub.productPhotoUrl, sub.installationPhotoUrl].filter(
          Boolean,
        ) as string[]
      }
      vlmGatekeeperResult={
        sub.vlmSimilarityResult as Record<string, unknown> | null
      }
