...
export const adminNavSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Schedule',
        href: '/admin/sponsorship/schedule',
        icon: 'schedule',
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        label: 'Trust Tier Thresholds',
        href: '/admin/settings/trust-tier',
        icon: 'trust',
        roles: ['ADMIN'],
      },
    ],
